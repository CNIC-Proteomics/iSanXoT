...
cp -r "${ISANXOT_HOME}/env/python/requirements_python_linux-x64.txt"  "${ISANXOT_HOME}/app/resources/env/python/."
cp -r "${ISANXOT_HOME}/env/python/packages/linux-x64"                 "${ISANXOT_HOME}/app/resources/env/python/packages/."
...
cp -r "${ISANXOT_HOME}/env/exec/requirements_exec_linux-x64.txt"  "${ISANXOT_HOME}/app/resources/env/exec/."
