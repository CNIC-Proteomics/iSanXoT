...
2. Save the User Guide Word document (docs/user_guides/User_Guide_iSanXoT-X.X.X.docx) as HTML (Web Page, Filtered) into the iSanXoT help section (iSanXoT/app/app/sections/help).
    1.1. Important!! Save as 'UTF-8' encoding.
